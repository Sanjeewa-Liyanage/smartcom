    ...
    <style>
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        :root {
            ...
            --accent:#1b5e20; --accent-light:#e8f5e9; --accent-mid:#43a047;
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?= BASE_URL ?>/tutor/dashboard" class="nav-link active" id="nav-tutor-dash">
        ...
        <a href="#" class="nav-link" style="opacity:0.4;cursor:not-allowed"><span class="material-icons">insert_drive_file</span> Materials</a>

<?php
/**
 * Forgot Password view — variables provided by AuthController via Controller::render():
 *
 * @var string $csrf   CSRF token for form submission
 * @var array  $errors Validation error messages (may be empty)
 * @var string $email  Previously submitted email
...
<head>
    ...
    <meta name="description" content="Reset your Smart Commerce Core password using a one-time verification code.">
...
<div class="left-panel">
    <div class="brand">
        ...
        <p>Reset your password securely with a one-time verification code sent to your email.</p>
        <div class="step-badges">
            <span class="step-badge active"><span class="material-icons">mail</span> Enter Email</span>
            <span class="step-badge"><span class="material-icons">pin</span> Verify OTP</span>
...
<div class="right-panel">
    <div class="form-card">
        <div class="form-card-header">
            ...
            <p>Enter your registered email address and we'll send you a 6-digit verification code.</p>
        </div>
        ...
        <form method="POST" action="<?= BASE_URL ?>/forgot-password" novalidate id="forgot-password-form">
            ...
            <button type="submit" class="btn-primary" id="btn-send-otp">Send Verification Code <span class="material-icons" style="font-size:18px;vertical-align:middle">arrow_forward</span></button>
        </form>

        <div class="divider">or</div>

        <div class="form-links">
            <a href="<?= BASE_URL ?>/login">Remember your password? <span>Sign in</span></a>
        </div>
    </div>
</div>

...
<head>
    ...
    <title>403 — Access Denied | Smart Commerce Core</title>
...
<div class="wrap">
    ...
    <h1>Access Denied</h1>
    <p>You don't have permission to access this page. Please make sure you're logged in with the correct account.</p>
    <a href="<?= BASE_URL ?>/login" id="btn-403-back">← Return to Login</a>
</div>
</body>
</html>
